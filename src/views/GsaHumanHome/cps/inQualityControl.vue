<template>
    <div class="pendingReview">
        ...
        <el-table ref="table" :data="tableData" style="width: 100%" height="950" @row-click="handleRowClick" border>
            ...
            <el-table-column prop="SubmissionID" label="Submission ID" align="center" />
            <el-table-column prop="ArchiveID" label="Archive ID" align="center" />
            <el-table-column prop="BioProject" label="BioProject" align="center" />
            <el-table-column prop="SubmitterEmail" label="Submitter email" align="center" />
            <el-table-column prop="MetadataSubmissionTime" label="Metadata submission time" align="center" />
            <el-table-column prop="MetadataReviewTime" label="Metadata review time" align="center" />
            <el-table-column prop="SubmissionStatus" label="Submission Status" align="center">
            ...
            <el-table-column prop="RunStatus" label="Run status" align="center" width="180">
                <template #default="scope">
                    <el-row>
            ...
            <el-table-column prop="ViewStyle" label="View Style" align="center">
                <template #default="scope">
                    <div> {{ getViewStyle(scope.row.viewStyle) }}</div>
                </template>
            </el-table-column>
            <el-table-column prop="ReleaseStatus" label="Release Status" align="center">
                <template #default="scope">
                    <div>{{ getReleaseStyle(scope.row.ReleaseStatus) }}</div>
                </template>
            </el-table-column>
            <el-table-column prop="Reviewer" label="Reviewer" align="center" />
